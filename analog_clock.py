...
circle = Turtle()
circle.penup()
circle.pencolor("#000000")
circle.speed(0)
circle.pensize(25)
circle.hideturtle()
circle.goto(0, -390)
circle.pendown()
circle.fillcolor("#010D0E")
circle.begin_fill()
circle.circle(400)
circle.end_fill()
...
pen.hideturtle()
pen.goto(170, 260)
pen.write("1", align="center", font=("Corbel Light", 50, "bold"))


pen.penup()
pen.hideturtle()
pen.goto(300, 140)
pen.write("2", align="center", font=("Corbel Light", 50, "bold"))


pen.penup()
pen.hideturtle()
pen.goto(340, -30)
pen.write("3", align="center", font=("Corbel Light", 50, "bold"))


pen.penup()
pen.hideturtle()
pen.goto(300, -200)
pen.write("4", align="center", font=("Corbel Light", 50, "bold"))


pen.penup()
pen.hideturtle()
pen.goto(170, -325)
pen.write("5", align="center", font=("Corbel Light", 50, "bold"))


pen.penup()
pen.hideturtle()
pen.goto(0, -370)
pen.write("6", align="center", font=("Corbel Light", 50, "bold"))


pen.penup()
pen.hideturtle()
pen.goto(-170, -325)
pen.write("7", align="center", font=("Corbel Light", 50, "bold"))


pen.penup()
pen.hideturtle()
pen.goto(-300, -200)
pen.write("8", align="center", font=("Corbel Light", 50, "bold"))


pen.penup()
pen.hideturtle()
pen.goto(-340, -30)
pen.write("9", align="center", font=("Corbel Light", 50, "bold"))


pen.penup()
pen.hideturtle()
pen.goto(-280, 140)
pen.write("10", align="center", font=("Corbel Light", 50, "bold"))


pen.penup()
pen.hideturtle()
pen.goto(-160, 260)
pen.write("11", align="center", font=("Corbel Light", 50, "bold"))


pen.penup()
pen.hideturtle()
pen.goto(0, 300)
pen.write("12", align="center", font=("Corbel Light", 50, "bold"))
